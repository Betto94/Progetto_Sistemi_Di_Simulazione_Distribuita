	...
	public void receiveInteraction(InteractionClassHandle interactionClass, 
		...
		try{
	        ...
	        case "REPORT_RECEIVED":
	        	//aggiunge l'evento alla lista degli eventi di ImpiantoM che lo informa che A ha ricevuto il report 
        	    federate.addEvent(new EventoLocaleM(EventType.REPORT_RECEIVED, eventTime));
        	    break;
	        }   	
